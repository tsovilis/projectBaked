    ...
    if (@$_SERVER['HTTPS'] !== 'on')
    {
		...
		<form method='post' action='{$_SERVER['PHP_SELF']}'>
			<table>
				<tr>
					<td>E-mail</td>
					<td colspan='2'><input type='text' name='email' size='18' value='E-mail'
					onfocus=\"if(this.value == 'E-mail') {this.value = '';}\" /></td>
				</tr>
				<tr>
					<td>Password</td>
					<td colspan='2'><input type=\"password\" name=\"wachtwoord\" size=\"18\" value=\"password\"
					onfocus=\"if(this.value == 'password') {this.value = '';}\"/></td>
				</tr>
				<tr>
					<td colspan='2'>
						<sub>Nog geen account?
						<a href='registratieBaked.php'> Registreer </a></sub>
					</td>
					<td style='width:50px'>
