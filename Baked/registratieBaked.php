...
<div id="main">
	<a href="infoBaked.php"> <img src="images/Bakedsign.png" alt="baked teken"/></a>
	...
	<div id="content"> <!-- The content of the website will be placed in this div. -->
		...
		<div id="inhoud"> <!-- In the middle is the content of the requested page. -->
			...
			<table>
				...
				<tr>
					<td>Wachtwoord:*</td> <td><input type="password" id="wachtwoord" name="wachtwoord" onkeyup="pwstrength();"/></td> <td><p id="count">Uw wachtwoord</p></td>
				</tr>
			...
			<p>
			<input type="checkbox" name="nieuwsbrief" value="5" /> 
			Ja, ik profiteer graag van alle voordelen en acties en schrijf me in voor de Baked Nieuwsbrief.
			</p>
